...
#ifndef LLAMAXML_RECODEOUTER_H_
#define LLAMAXML_RECODEOUTER_H_
...
namespace LlamaXML {
	...
	// This class takes care of doing a lazy initialization of the recode
	// library, while making sure it is cleaned up when the application exits.
	
	class RecodeOuter {
	public:
		static RECODE_OUTER Get();
